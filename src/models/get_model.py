...
ARCHINAMES = ["fc", "gru", "transformer", "transgru", "grutrans", "autotrans","gcngru","gcngrutrans","gcnmoe","gcntrans","gcntrans2","gcngrugru","gcntcngru","gcntcntcn","gcntcntcn2","gcntcnfilm","gcntcnfilmin","gcntcnfilmz"]
