...
def add_dataset_options(parser):
    ...
    group.add_argument("--max_len", default=150, type=int, help="number of frames maximum per sequence or -1")
    group.add_argument("--min_len", default=150, type=int, help="number of frames minimum per sequence or -1")
